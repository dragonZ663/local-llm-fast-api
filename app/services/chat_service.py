...
from app.schemas import (ChatCompletionChoice, ChatCompletionChunk,
                         ChatCompletionChunkChoice,
                         ChatCompletionChunkChoiceDelta, ChatCompletionRequest,
    ...
    async def create_completion(
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail={
                    ...
                    "details": {"endpoint": "/chat/completions", "error": "timeout"},
                },
            )
        ...
        usage = {
            ...
            "completion_tokens": data.get(
                "completion_tokens", len(data["content"].split())
            ),
            "total_tokens": 0,
        }
        usage["total_tokens"] = data.get(
